...
interface VenueSalesTimeSeriesChartProps {
...
export const VenueSalesTimeSeriesChart: React.FC<VenueSalesTimeSeriesChartProps> = ({
  timeseries,
  eventsPresent = {},
  isLoading = false
}) => {
        ...
        <div className="bg-background border border-border rounded-lg shadow-lg p-3">
          ...
          <div className="space-y-1">
            ...
            {chartMode === 'revenue' && (
              <>
                <p className="text-sm">
                  <span className="font-medium">Venue Revenue:</span> {formatCurrency(data.daily_revenue, '₺')}
                </p>
                <p className="text-sm">
            ...
            {chartMode === 'events' && (
              <>
                <p className="text-sm">
                  <span className="font-medium">Events Hosted:</span> {data.events_count}
                </p>
                <p className="text-sm">
            ...
            {data.events_count > 0 && (
              <div className="border-t pt-2 mt-2">
                <p className="text-xs font-medium mb-1">Events Hosted ({data.events_count}):</p>
                <div className="space-y-1">
  ...
  const getChartTitle = () => {
    switch (chartMode) {
      case 'revenue':
        return 'Daily Venue Revenue Performance';
      case 'sales':
        return 'Daily Ticket Sales at Venue';
      case 'events':
        return 'Venue Event Activity Timeline';
      default:
        return 'Venue Sales Analytics';
    }
  };
  ...
  const getChartDescription = () => {
    switch (chartMode) {
      case 'revenue':
        return 'Track daily revenue from all events hosted at this venue';
      case 'sales':
        return 'Monitor ticket sales velocity and patterns at this venue';
      case 'events':
        return 'Visualize event hosting activity and venue utilization';
      default:
        return 'Comprehensive venue performance analytics';
    }
  };
          ...
          {chartMode === 'events' && (
            <>
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-muted-foreground">Avg Events Hosted</div>
              </div>
            </>
          )}
        </div>
