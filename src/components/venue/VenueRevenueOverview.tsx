...
import { VenueTicketTotals } from '@/hooks/useVenueTickets';
import { formatCurrency } from '@/utils/formatters';
import { DollarSign, TrendingUp, Target, PieChart } from 'lucide-react';

interface VenueRevenueOverviewProps {
  totals: VenueTicketTotals;
  isLoading?: boolean;
}

export const VenueRevenueOverview: React.FC<VenueRevenueOverviewProps> = ({
  totals,
  isLoading = false
}) => {
  if (isLoading) {
