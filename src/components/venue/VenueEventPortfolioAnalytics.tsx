...
import { Calendar, Star, MapPin, Building2 } from 'lucide-react';
...
export const VenueEventPortfolioAnalytics: React.FC<VenueEventPortfolioAnalyticsProps> = ({
  ...
  const eventMetrics = useMemo(() => {
    ...
    // Calculate basic metrics for each event hosted at this venue
    ...
    <Card>
      <CardHeader>
        ...
        <p className="text-xs text-muted-foreground">
          {eventMetrics.length} events hosted at this venue
        </p>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
